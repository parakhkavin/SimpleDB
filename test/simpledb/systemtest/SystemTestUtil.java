...
public class SystemTestUtil {
	...
	/**
	 * Checks if the sequence represents a quadratic sequence (approximately) ret[0]
	 * is true if the sequence is quadratic ret[1] is the common difference of the
	 * sequence if ret[0] is true.
	 * 
	 * @param sequence
	 ...
	 * ret[0] is true if the sequence is linear ret[1] is the constant of the
	 * sequence if ret[0] is true.
	 * 
	 * @param sequence
