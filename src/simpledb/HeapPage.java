...
public class HeapPage implements Page {
	...
	private TransactionId lastDirtyingTx = null;
	...
	public void deleteTuple(Tuple t) throws DbException {
		for (int i = 0; i < numSlots; i++) {
			if (getSlot(i) && tuples[i].equals(t)) {
				setSlot(i, false);
				return;
			}
		}
	...
	public void addTuple(Tuple t) throws DbException {
		...
		throw new DbException("Page is full, no empty slots available");
	}
	...
	public void markDirty(boolean dirty, TransactionId tid) {
		this.lastDirtyingTx = dirty ? tid : null;
	}
	...
	public Iterator<Tuple> iterator() {
		return new Iterator<>() {
            ...
            public boolean hasNext() {
                while (currentIdx + 1 < numSlots) {
                    if (getSlot(currentIdx + 1)) {
                        return true;
                    }
                    currentIdx++;
                }
